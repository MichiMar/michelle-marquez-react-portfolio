...
export default class BlogForm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiURL: "https://michellemarquez.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiURL: `https://michellemarquez.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
  ...
  handleSubmit(event) {
    ...
    axios({
      ...
      .post(this.state.apiURL, this.buildForm(), { withCredentials: true })
      .then(response => {
        if (this.state.featured_image) {
        ...
        if (this.props.editMode) {
          // update blog detail
          this.props.handleUpdateForSubmission(response.data.portfolio_blog);
        } else {
